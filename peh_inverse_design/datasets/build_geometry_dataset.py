...
if __package__ in (None, ""):
    ...
    from peh_inverse_design.geometry.geometry_pipeline import GeometryBuildConfig, build_geometry_dataset
else:
    from ..geometry.geometry_pipeline import GeometryBuildConfig, build_geometry_dataset
